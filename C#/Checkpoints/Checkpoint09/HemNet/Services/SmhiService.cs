   ...
   public class SmhiService
    {
        ...
        public async Task<Rootobject> GetMeteorologicalForecast(decimal longitude, decimal latitude)
        {
            ...
            string result = await Get("https://opendata-download-metfcst.smhi.se/api/category/pmp3g/version/2/geotype/point/lon/" + sLongitude + "/lat/" + sLatitude + "/data.json");
