...
namespace HemNet.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder)
        {
            ...
            ViewBag.NameSortParm = String.IsNullOrEmpty(sortOrder) ? "number_desc" : "";
            ViewBag.DateSortParm = sortOrder == "Price" ? "price_desc" : "Price";
            var students = from s in _context.Apartments.Include(x => x.HousingCooperative)
                           select s;
            switch (sortOrder)
            {
                case "number_desc":
                    students = students.OrderByDescending(s => s.ApartmentNumber);
                    break;
                case "Price":
                ...
                case "price_desc":
                    ...
                    break;
                default:
                    students = students.OrderBy(s => s.ApartmentNumber);
                    break;
            }
